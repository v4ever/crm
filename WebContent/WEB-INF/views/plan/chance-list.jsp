					...
					<tr>
						...
						<td class="list_data_op">
							<c:if test="${item.status == 2 }">
								...
								<img
									onclick="window.location.href='${ctp}/plan/execution?id=20020'"
									title="执行计划" src="${ctp}/static/images/bt_feedback.gif" class="op_button" />
								<img 
									onclick="window.location.href='${ctp}/chance/finish?id=20020'"
									title="开发成功" src="${ctp}/static/images/bt_yes.gif" class="op_button" />
							</c:if>
							<c:if test="${item.status == 3 || item.status == 4 }">
								<img
									onclick="window.location.href='/crm_/chance/detail?id=20001'"
