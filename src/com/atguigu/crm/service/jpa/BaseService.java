...
import com.atguigu.crm.repository.BaseRepository;
...
public class BaseService<T, PK extends Serializable>{
	...
	private Specification<T> parsePropertyFiltersToSpecification(
	...
	public void save(T dict){
		repository.saveAndFlush(dict);
	}
}
